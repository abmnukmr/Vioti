...
var AdditemPage = (function () {
    function AdditemPage(navCtrl, victrl, actionSheetCtrl, toastCtrl, platform, loadingCtrl) {
    ...
    AdditemPage.prototype.Dismiss4 = function () {
        this.victrl.dismiss();
    };
    AdditemPage.prototype.openMenu = function () {
        var _this = this;
    ...
    AdditemPage.prototype.deletes = function (i) {
    ...
    AdditemPage.prototype.uploadImage = function () {
        var _this = this;
...
], AdditemPage.prototype, "input", void 0);
